...
class Args:
    ...
    """overall weight of the softplus speed-hinge penalty; 0 disables it."""
    speed_threshold: float = 4.0
    """speed (m/s) above which the softplus hinge penalizes; the drone races freely below it and
    pays a smooth, roughly linear cost per m/s above it."""
    speed_softness: float = 3.0
    """sharpness (1/(m/s)) of the softplus knee at speed_threshold: larger = a sharper knee that
    bites closer to the threshold and leaks less below it; smaller = a softer, rounder knee."""
