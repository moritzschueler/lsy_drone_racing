...
def main(
    ...
    **kwargs: Any,
    ...
    if ego_start_delay > 0.0:
        ...
        # hold. Waypoints/gates are irrelevant here (never advanced past t=0), so gates=None. This
        # is independent of ``opponent`` -- it works whether drones 1.. are the scripted PID or a
