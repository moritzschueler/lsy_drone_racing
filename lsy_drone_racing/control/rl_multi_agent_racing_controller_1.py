...
class RLMultiAgentRacingController(Controller):
    ...
    def __init__(self, obs: dict[str, NDArray[np.floating]], info: dict, config: dict):
        ...
        checkpoint_path = "/home/moritz_schueler/lsy_drone_racing/lsy_drone_racing/rl/checkpoints/multi_agent_racing/multi_agent_racing_20260726-162248_g3.67_step299630592.ckpt"
